#ifndef CLICK_PRINTSGX_HH
#define CLICK_PRINTSGX_HH
...
print_SGX([LABEL, MAXLENGTH, I<keywords>])
...
class print_SGX : public Element { public:

    print_SGX() CLICK_COLD;

    const char *class_name() const		{ return "print_SGX"; }
