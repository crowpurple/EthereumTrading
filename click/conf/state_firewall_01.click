...
feth0 :: FromDevice("eth0", OUTBOUND 1);
teth0 :: ToDevice("eth0");
feth1 :: FromDevice("eth1");
teth1 :: ToDevice("eth1");
feth2 :: FromDevice("eth2", OUTBOUND 1);
teth2 :: ToDevice("eth2");
...
VNF_OUT[0] -> SimpleQueue() -> teth0;
VNF_OUT[1] -> SimpleQueue() -> teth1;
VNF_OUT[2] -> teth2;
//VNF_OUT[1] -> teth1;
//VNF_OUT[2] -> teth2;
//-------------------------------------------------------------------//
...
firewall_match[0] -> SimpleQueue() -> Unqueue() -> traffic_out -> [0]VNF_OUT;
